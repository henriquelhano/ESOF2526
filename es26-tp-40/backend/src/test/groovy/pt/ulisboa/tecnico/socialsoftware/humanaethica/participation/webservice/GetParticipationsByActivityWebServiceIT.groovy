...
class GetParticipationsByActivityWebServiceIT extends SpockTest {
    ...
    def setup() {
        ...
        def enrollmentDto1 = new EnrollmentDto()
        enrollmentDto1.motivation = ENROLLMENT_MOTIVATION_1
        enrollmentDto1.shiftIds = [shift.id]
        def enrollment1 = enrollmentService.createEnrollment(volunteerOne.id, enrollmentDto1)

        def enrollmentDto2 = new EnrollmentDto()
        enrollmentDto2.motivation = ENROLLMENT_MOTIVATION_1
        enrollmentDto2.shiftIds = [shift.id]
        def enrollment2 = enrollmentService.createEnrollment(volunteerTwo.id, enrollmentDto2)
