...
class GetEnrollmentsByActivityWebServiceIT extends SpockTest {
    ...
    def setup() {
        ...
        def shift1 = createShift(activity, createShiftDto(SHIFT_LOCATION_1, IN_TWO_DAYS, IN_THREE_DAYS, 1))
        def shift2 = createShift(activity, createShiftDto(SHIFT_LOCATION_1, IN_TWO_DAYS, IN_THREE_DAYS, 1))
        ...
        and:
        createEnrollment(volunteerOne, [shift1], ENROLLMENT_MOTIVATION_1)
        createEnrollment(volunteerTwo, [shift2], ENROLLMENT_MOTIVATION_2)
    }
