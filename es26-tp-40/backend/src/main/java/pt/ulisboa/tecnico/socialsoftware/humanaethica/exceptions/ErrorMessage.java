...
public enum ErrorMessage {
    ...
    SHIFT_LOCATION_INVALID("Shift location is missing"),
    SHIFT_TIME_NULL("Shift time is null"),
    SHIFT_START_AFTER_END("Shift start is after end"),
    SHIFT_DATES_OUTSIDE_ACTIVITY("Shift dates are outside activity dates"),
    SHIFT_PARTICIPANTS_LIMIT_INVALID("Shift participants limit is invalid"),
    SHIFT_ACTIVITY_NOT_APPROVED("Activity's state is not approved"),
    SHIFT_PARTICIPANTS_LIMIT_EXCEEDS_ACTIVITY("Shift participants limit exceeds activity participants limit"),

    // ShiftEnrollment
    ENROLLMENT_SHIFTS_OVERLAP("The shifts of this enrollment overlap with another enrollment of the same volunteer"),
    ENROLLMENT_SHIFTS_FROM_DIFFERENT_ACTIVITIES("The shifts of this enrollment are from to different activities"),

    // ShiftParticipation
    PARTICIPATION_SHIFT_IS_FULL("The number of participants in a Shift must be less or the same as the limit"),

    // ParticipationEnrollment
    PARTICIPATION_ENROLLMENT_DOES_NOT_HAVE_SHIFT("The enrollment associated with that participation must have the shift of participation");
