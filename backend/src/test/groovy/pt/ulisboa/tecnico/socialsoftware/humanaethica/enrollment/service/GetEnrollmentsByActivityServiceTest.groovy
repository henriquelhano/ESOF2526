...
class GetEnrollmentsByActivityServiceTest extends SpockTest {
    ...
    def "get two enrollments of the same activity"() {
        ...
        createEnrollment(volunteerOne, [shift], ENROLLMENT_MOTIVATION_1)
        createEnrollment(volunteerTwo, [shift], ENROLLMENT_MOTIVATION_2)
    ...
    def "get one enrollment of an activity"() {
        ...
        and:
        def shift = createShift(activity, createShiftDto(SHIFT_LOCATION_1, IN_TWO_DAYS, IN_THREE_DAYS, 1))
        def otherShift = createShift(otherActivity, createShiftDto(SHIFT_LOCATION_2, IN_TWO_DAYS, IN_THREE_DAYS, 1))
        createEnrollment(volunteer, [shift], ENROLLMENT_MOTIVATION_1)
        createEnrollment(volunteer, [otherShift], ENROLLMENT_MOTIVATION_2)
