...
export default class RemoteServices {
  ...
  static async createParticipation(
    ...
    return httpClient
      .post(`/participations/${shiftId}/enrollment/${enrollmentId}`, participation)
      .then((response) => {
  ...
  static async createShift(activityId: number, shift: Shift) {
    return httpClient
    ...
    static async getShiftsByActivity(activityId: number): Promise<Shift[]> {
      return httpClient
